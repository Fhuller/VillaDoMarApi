...
namespace VillaDoMarApi.Controllers
{
    ...
    public class FinancialController : ControllerBase
    {
        ...
        public async Task<ActionResult<Financial>> InsertCaixa(CaixaDto caixa)
        {
            if (!await CaixaEstaAberto())
                return BadRequest("O caixa est� fechado, n�o � poss�vel adicionar transa��es");
        ...
        {
            if (!await CaixaEstaAberto())
                return BadRequest("O caixa est� fechado, n�o � poss�vel editar transa��es");
        ...
        {
            if (!await CaixaEstaAberto())
                return BadRequest("O caixa est� fechado, n�o � poss�vel excluir transa��es");
            ...
            await _context.SaveChangesAsync();
            return Ok("Transa��o deletada com sucesso!");
        }
        ...
        public async Task<ActionResult> AbrirCaixa()
        {
            ...
            if (caixaAberto)
                return BadRequest("J� existe um caixa aberto");
        ...
        public async Task<ActionResult> FecharCaixa()
        {
            ...
            if (caixaAberto == null)
                return BadRequest("N�o existe um caixa aberto");
    ...
    {
        throw new InvalidOperationException("Mais de um caixa está aberto.");
    }
